...
namespace EmbeddedResources
{
    ...
    [CompilerGenerated]
    internal class EmbeddedResourceBuilder
    {
        ...
        internal static ResourceManager ResourceManager
        {
            get
            {
                if (ReferenceEquals(resourceManager_0, null))
                    resourceManager_0 = new ResourceManager("SynapseGaming.LightingSystem.Effects.Resources", typeof (EmbeddedResourceBuilder).Assembly);
