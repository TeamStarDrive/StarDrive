...
namespace ns9
{
    internal class Class70
    {
        ...
        private List<Buffer> list_0 = new List<Buffer>(32);
        ...
        public List<Buffer> Buffers => this.list_0;
        ...
        public Class70(GraphicsDevice device, DisposablePool<Buffer> bufferfactory, Effect effect)
        {
        ...
        public void method_1()
        {
            if (this.Buffer0 == null || this.int_3 < 1)
                return;
            this.Buffer0.method_0(this.graphicsDevice_0, this.struct1_0, Class70.ushort_0, this.int_3);
        }

        private void method_2()
        {
            this.Buffer0 = this.class22_0.New();
            this.list_0.Add(this.Buffer0);
            this.int_3 = 0;
        }

        public void method_3()
        {
            foreach (Buffer class69 in this.list_0)
                this.class22_0.Free(class69);
            this.Buffer0 = (Buffer)null;
            this.list_0.Clear();
            this.int_3 = 0;
        }
    }
