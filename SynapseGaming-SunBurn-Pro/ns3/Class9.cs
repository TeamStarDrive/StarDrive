...
namespace ns3
{
  internal class Class9<T>
  {
    ...
    public void method_0(ref BoundingBox boundingBox_1, int int_1)
    {
      ...
      float x = vector3.X;
      int index1 = 0;
      Class9<T>.float_0[0] = vector3.X;
      Class9<T>.float_0[1] = vector3.Y;
      Class9<T>.float_0[2] = vector3.Z;
      for (int index2 = 1; index2 < 3; ++index2)
      {
        if ((double) x <= (double) Class9<T>.float_0[index2])
        {
          x = Class9<T>.float_0[index2];
          index1 = index2;
        }
      }
      this.enum2_0 = (Class9<T>.Enum2) index1;
      Class9<T>.float_0[0] = 0.0f;
      Class9<T>.float_0[1] = 0.0f;
      Class9<T>.float_0[2] = 0.0f;
      Class9<T>.float_0[index1] = 1f;
      this.plane_0.Normal.X = Class9<T>.float_0[0];
      this.plane_0.Normal.Y = Class9<T>.float_0[1];
      this.plane_0.Normal.Z = Class9<T>.float_0[2];
      Class9<T>.float_0[0] = this.boundingBox_0.Min.X;
      Class9<T>.float_0[1] = this.boundingBox_0.Min.Y;
      Class9<T>.float_0[2] = this.boundingBox_0.Min.Z;
      this.plane_0.D = (float) -((double) Class9<T>.float_0[index1] + (double) x * 0.5);
    }
    ...
    {
      bool flag1 = (double) this.plane_0.DotCoordinate(boundingBox_1.Max) > 0.0;
      bool flag2 = (double) this.plane_0.DotCoordinate(boundingBox_1.Min) > 0.0;
