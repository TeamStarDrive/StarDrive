...
namespace SynapseGaming.LightingSystem.Rendering
{
  ...
  public class Avatar : IMovableObject, IAvatar
  {
    ...
    private BoundingBox boundingBox_2;
    private BoundingSphere boundingSphere_0;
    private BoundingBox boundingBox_3;
    private IList<Matrix> ilist_0;
    private AvatarExpression avatarExpression_0;
    private AvatarRenderer avatarRenderer_0;
    private AvatarDescription avatarDescription_0;
    ...
    public AvatarExpression Expression
    {
      get
      {
        return this.avatarExpression_0;
      }
      set
      {
        this.avatarExpression_0 = value;
      }
    }
    ...
    /// </summary>
    public BoundingBox WorldBoundingBoxProxy
    {
      get
      {
        return this.boundingBox_3;
      }
    }
    ...
    public AvatarDescription Description
    {
      get
      {
        return this.avatarDescription_0;
      }
    }
    ...
    public bool CastShadows
    {
      get
      {
        return (this.objectVisibility_0 & ObjectVisibility.CastShadows) != ObjectVisibility.None;
      }
    }
    ...
    public bool Visible
    {
      get
      {
        return (this.objectVisibility_0 & ObjectVisibility.Rendered) != ObjectVisibility.None;
      }
    }
    ...
    {
      if (Avatar.list_0.Count < 71)
      {
        for (int count = Avatar.list_0.Count; count < 71; ++count)
          Avatar.list_0.Add(Matrix.Identity);
      }
      this.ilist_0 = (IList<Matrix>) Avatar.list_0;
    ...
    {
      this.ilist_0 = (IList<Matrix>) animation.BoneTransforms;
      this.avatarExpression_0 = animation.Expression;
    }
