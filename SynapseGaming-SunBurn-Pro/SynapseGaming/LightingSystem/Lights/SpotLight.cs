...
namespace SynapseGaming.LightingSystem.Lights
{
  ...
  public class SpotLight : IMovableObject, INamedObject, IEditorObject, ISerializable, ILight, IPointSource, IDirectionalSource, ISpotSource, IShadowSource
  {
      ...
      foreach (SerializationEntry serializationEntry in serializationInfo_0)
      {
        switch (serializationEntry.Name)
        {
          ...
          case "Direction":
            ...
            continue;
          case "Angle":
            Class28.smethod_0(ref this.float_6, serializationInfo_0, "Angle");
            continue;
          case "Volume":
            Class28.smethod_0(ref this.float_7, serializationInfo_0, "Volume");
            continue;
          case "Name":
    ...
    {
      float num = (float) Math.Tanh(MathHelper.ToRadians(MathHelper.Clamp(this.float_6, 1f / 1000f, 179.99f) * 0.5f)) * this.float_5;
      this.WorldBoundingBox = CoreUtils.smethod_5(new BoundingBox(new Vector3(-num, -num, -this.float_5), new Vector3(num, num, 0.0f)), this.matrix_0);
