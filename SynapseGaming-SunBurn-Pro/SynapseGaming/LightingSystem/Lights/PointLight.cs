...
namespace SynapseGaming.LightingSystem.Lights
{
  ...
  /// </summary>
  [Serializable]
  public class PointLight : IMovableObject, INamedObject, IEditorObject, ISerializable, ILight, IPointSource, IShadowSource
  {
    ...
    private void method_0()
    {
      ...
      this.boundingSphere_0 = new BoundingSphere(this.matrix_0.Translation, this.float_5);
    }
