...
namespace SynapseGaming.LightingSystem.Core
{
  ...
  public class ObjectGraph<T> : IQuery<T>, ISubmit<T> where T : IMovableObject
  {
    ...
    private ObjectGraph<T>.Class19 class19_0 = new ObjectGraph<T>.Class19();
    ...
    public virtual void Find(List<T> foundobjects, BoundingFrustum worldbounds, ObjectFilter objectfilter)
    {
      ...
      worldbounds.GetCorners(this.vector3_0);
      this.list_0.Clear();
      this.class9_0.method_7(Class13.smethod_11(this.vector3_0), this.list_0);
