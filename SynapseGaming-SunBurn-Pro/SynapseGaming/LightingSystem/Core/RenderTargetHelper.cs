  ...
  public class RenderTargetHelper : IUnloadable, IManager, IRenderableManager
  {
    ...
    public void BeginFrameRendering(ISceneState scenestate, Plane worldreflectionplane, Plane worldclippingplane)
    {
      ...
      else
      {
        ...
        this.sceneState_0.BeginFrameRendering(Matrix.CreateReflection(worldreflectionplane) * scenestate.View, scenestate.Projection, scenestate.GameTime, scenestate.Environment, scenestate.RenderingToScreen);
      }
    }
