...
namespace Ship_Game
{
    public sealed class ParticleSystem : IDisposable
    {
        ...
        public ParticleSystem(GameContentManager content, ParticleSettings settings, GraphicsDevice device) 
            : this(content, settings, device, 1, -1){}
        public ParticleSystem(GameContentManager content, ParticleSettings settings, GraphicsDevice device, float scale) 
            : this(content, settings, device, scale, -1) { }
        public ParticleSystem(GameContentManager content, ParticleSettings settings, GraphicsDevice device, float scale, int particleCount)
        {
        ...
        void LoadContent(ParticleSettings settings)
        {
            Settings = settings;
