...
namespace Ship_Game.Data.Serialization.Types
{
    internal class Vector2Serializer : TypeSerializer
    {
        ...
        public override string ToString() => $"Vector2Serializer:{TypeId}";
    ...
    internal class Vector2dSerializer : TypeSerializer
    {
        ...
        public override string ToString() => $"Vector2dSerializer:{TypeId}";
    ...
    internal class Vector3Serializer : TypeSerializer
    {
        ...
        public override string ToString() => $"Vector3Serializer:{TypeId}";
    ...
    internal class Vector3dSerializer : TypeSerializer
    {
        ...
        public override string ToString() => $"Vector3dSerializer:{TypeId}";
    ...
    internal class Vector4Serializer : TypeSerializer
    {
        ...
        public override string ToString() => $"Vector4Serializer:{TypeId}";
    ...
    internal class PointSerializer : TypeSerializer
    {
        ...
        public override string ToString() => $"PointSerializer:{TypeId}";
    ...
    internal class RectangleSerializer : TypeSerializer
    {
        ...
        public override string ToString() => $"RectangleSerializer:{TypeId}";
    ...
    internal class RectFSerializer : TypeSerializer
    {
        ...
        public override string ToString() => $"RectFSerializer:{TypeId}";
