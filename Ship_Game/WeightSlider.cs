	...
	public class WeightSlider
	{
		...
		public void Draw(Ship_Game.ScreenManager ScreenManager)
		{
			...
			if (this.amount > 0.5f)
			{
				...
				ScreenManager.SpriteBatch.Draw(ResourceManager.TextureDict["NewUI/slider_grd_green"], new Rectangle(this.greenRect.X, this.rect.Y, (int)(greenamount * (float)this.greenRect.Width), 6), new Rectangle?(new Rectangle(this.rect.X, this.rect.Y, (int)(greenamount * (float)this.greenRect.Width), 6)), Color.White);
			}
			...
			if (this.Hover)
			{
				ScreenManager.SpriteBatch.Draw(ResourceManager.TextureDict["NewUI/slider_crosshair_hover"], drawRect, Color.White);
			}
			else
			{
				ScreenManager.SpriteBatch.Draw(ResourceManager.TextureDict["NewUI/slider_crosshair"], drawRect, Color.White);
			}
