...
namespace Ship_Game.Fleets
{
    public sealed class Fleet : ShipGroup
    {
            ...
            switch (TaskStep)
            {
                ...
                case 3:
                    if (ArrivedAtCombatRally(FinalPosition))
                    {
                        ...
                        EscortingToPlanet(combatOffset, MoveOrder.Defensive);
                    }
                    break;
                case 4:
        ...
        void DoRemnantEngagement(MilitaryTask task)
        {
            ...
            switch (TaskStep)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    FleetMoveToPosition(task.AO, target.GravityWellRadius * 1.5f, MoveOrder.Defensive);
                    TaskStep = 4;
                    break;
                case 4:
                    if (!ArrivedAtCombatRally(FinalPosition, GetRelativeSize().Length() * 2))
        ...
        bool HasArrivedAtRallySafely(float fleetRadius = 0)
        {
            ...
            {
                MoveOrder order = CommandShip.IsInhibitedByUnfriendlyGravityWell ? MoveOrder.Aggressive : MoveOrder.Defensive;
