...
namespace Ship_Game
{
	public sealed class Menu1
	{
		...
		public Menu1(Rectangle theMenu)
		{
            ...
            corner_BL = new Rectangle(theMenu.X, theMenu.Y + theMenu.Height - ResourceManager.TextureDict["NewUI/menu_1_corner_BL"].Height, ResourceManager.TextureDict["NewUI/menu_1_corner_BL"].Width, ResourceManager.TextureDict["NewUI/menu_1_corner_BL"].Height);
            corner_BR = new Rectangle(theMenu.X + theMenu.Width - ResourceManager.TextureDict["NewUI/menu_1_corner_BR"].Width, theMenu.Y + theMenu.Height - ResourceManager.TextureDict["NewUI/menu_1_corner_BR"].Height, ResourceManager.TextureDict["NewUI/menu_1_corner_BR"].Width, ResourceManager.TextureDict["NewUI/menu_1_corner_BR"].Height);
            horizTop = new Rectangle(corner_TL.X + corner_TL.Width, corner_TL.Y, theMenu.Width - corner_TL.Width - corner_TR.Width, ResourceManager.TextureDict["NewUI/menu_1_horiz_upper"].Height);
            horizBot = new Rectangle(corner_BL.X + corner_BL.Width, theMenu.Y + theMenu.Height - ResourceManager.TextureDict["NewUI/menu_1_horiz_lower"].Height, theMenu.Width - corner_BL.Width - corner_BR.Width, ResourceManager.TextureDict["NewUI/menu_1_horiz_lower"].Height);
