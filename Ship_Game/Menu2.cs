...
namespace Ship_Game
{
	public sealed class Menu2 : UIElementV2
	{
	    ...
	    public Menu2(Rectangle theMenu) : this(null, theMenu, new Color(0, 0, 0, 240))
	    {
	    }
	    public Menu2(UIElementV2 parent, Rectangle theMenu) : this(parent, theMenu, new Color(0, 0, 0, 240))
	    {
	    }
        public Menu2(UIElementV2 parent, Rectangle theMenu, Color color) : base(parent, theMenu)
		{
		    Menu = theMenu;
