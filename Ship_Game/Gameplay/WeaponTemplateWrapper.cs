...
namespace Ship_Game.Gameplay
{
    ...
    public class WeaponTemplateWrapper : IWeaponTemplate
    {
        ...
        {
            // Calculate offense with this wrapper virtual overrides
            return WeaponTemplate.CalculateOffense(m, this);
        }
        ...
        {
            return WeaponTemplate.GetDamageWithBonuses(owner, this);
        }

        public float GetActualRange(Empire owner)
        {
            return WeaponTemplate.GetActualRange(owner, this);
        }
    }
}
