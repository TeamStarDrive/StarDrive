...
public sealed class RuleOptionsScreen : GameScreen
{
    ...
    public override void LoadContent()
    {
        ...
        Checkbox(ftlRect.X + indent, ftlRect.Y + 25*9, () => P.EnableRandomizedAIFleetSizes, title: GameText.EnableRandomizedAIFleetSizes, tooltip: GameText.EnableRandomizedAIFleetSizesTip);

        var mdRect = new Rectangle(ftlRect.X + indent+2, ftlRect.Y + 255, 270, 50);
        ...
        var vaRect = new Rectangle(ftlRect.X + indent + 2, ftlRect.Y + 320, 270, 50);
