...
namespace Ship_Game.GameScreens.ShipDesignScreen
{
    public sealed class ShipDesignWarningScreen : GameScreen
    {
        ...
        public ShipDesignWarningScreen(Ship_Game.ShipDesignScreen screen, Empire player, Array<DesignIssueDetails> issues, Color color) : base(screen)
        {
            Player            = player;
            TitleColor        = color;
            DesignIssues      = issues;
        ...
        {
            Window = Add(new Menu2(new Rectangle(ScreenWidth / 2 - 300, ScreenHeight / 2 - 250, 600, 500)));
