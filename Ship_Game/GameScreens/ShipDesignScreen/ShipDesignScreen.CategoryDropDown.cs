        ...
        {            
            ...
            public override bool HandleInput(InputState input)
            {
                if (Rect.HitTest(input.CursorPosition)) //fbedard: add tooltip for CategoryList
                {
                    ...
                    {
                        default:
                        case ShipData.Category.Unclassified: ToolTip.CreateTooltip("Repair when structural integrity is 35% or less"); break;
                        ...
                        case ShipData.Category.Combat: ToolTip.CreateTooltip("Repair when structural integrity is 25% or less"); break;
                        case ShipData.Category.Bomber: ToolTip.CreateTooltip("Repair when structural integrity is 40% or less. " +
                                                                             "Designate as Bomber/Anti Capital. Dynamic Bomber Hangars " +
                                                                             "will be able to pick the best from this category"); break;
                        case ShipData.Category.Fighter:  ToolTip.CreateTooltip("Repair when structural integrity is 20% or less. " +
