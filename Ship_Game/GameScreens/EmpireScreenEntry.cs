...
namespace Ship_Game
{
	public sealed class EmpireScreenEntry
	{
		...
		public EmpireScreenEntry(Planet planet, int x, int y, int width1, int height, EmpireScreen eScreen)
		{
			...
			SysNameRect = new Rectangle(x, y, (int)((float)(TotalEntrySize.Width - (SliderWidth + 150)) * 0.17f) - 30, height);
			PlanetNameRect = new Rectangle(x + SysNameRect.Width, y, (int)((float)(TotalEntrySize.Width - (SliderWidth + 150)) * 0.17f), height);
			...
			StorageRect = new Rectangle(x + SysNameRect.Width + PlanetNameRect.Width + SliderRect.Width + 150, y, (int)((float)(TotalEntrySize.Width - (SliderWidth + 120)) * 0.33f), height);
			QueueRect = new Rectangle(x + SysNameRect.Width + PlanetNameRect.Width + SliderRect.Width + StorageRect.Width + 150, y, (int)((float)(TotalEntrySize.Width - (SliderWidth + 150)) * 0.33f), height);
			float width = (float)((int)((float)SliderRect.Width * 0.8f));
			if (SliderWidth == 250)
			{
				width = 180f;
			}
			...
			Rectangle foodRect = new Rectangle(SliderRect.X + 10, SliderRect.Y + (int)(0.25 * (double)SliderRect.Height), (int)width, 6);
			...
			Rectangle prodRect = new Rectangle(SliderRect.X + 10, SliderRect.Y + (int)(0.5 * (double)SliderRect.Height), (int)width, 6);
			...
			Rectangle resRect = new Rectangle(SliderRect.X + 10, SliderRect.Y + (int)(0.75 * (double)SliderRect.Height), (int)width, 6);
			...
			FoodStorage = new ProgressBar(new Rectangle(StorageRect.X + 50, SliderRect.Y + (int)(0.25 * (double)SliderRect.Height), (int)(0.4f * (float)StorageRect.Width), 18))
			{
				Max = p.MaxStorage,
				Progress = p.FoodHere,
				color = "green"
			};
			int ddwidth = (int)(0.2f * (float)StorageRect.Width);
			if (GlobalStats.IsGermanOrPolish)
			{
				ddwidth = (int)Fonts.Arial12.MeasureString(Localizer.Token(330)).X + 22;
			}
			foodDropDown = new DropDownMenu(new Rectangle(StorageRect.X + 50 + (int)(0.4f * (float)StorageRect.Width) + 20, FoodStorage.pBar.Y + FoodStorage.pBar.Height / 2 - 9, ddwidth, 18));
			...
			ProdStorage = new ProgressBar(new Rectangle(StorageRect.X + 50, FoodStorage.pBar.Y + FoodStorage.pBar.Height + 10, (int)(0.4f * (float)StorageRect.Width), 18))
			{
				Max = p.MaxStorage,
			...
			prodDropDown = new DropDownMenu(new Rectangle(StorageRect.X + 50 + (int)(0.4f * (float)StorageRect.Width) + 20, ProdStorage.pBar.Y + FoodStorage.pBar.Height / 2 - 9, ddwidth, 18));
		...
		public void Draw(ScreenManager ScreenManager)
		{
			...
			if (Fonts.Pirulen16.MeasureString(p.ParentSystem.Name).X <= (float)SysNameRect.Width)
			{
				Vector2 SysNameCursor = new Vector2((float)(SysNameRect.X + SysNameRect.Width / 2) - Fonts.Pirulen16.MeasureString(p.ParentSystem.Name).X / 2f, (float)(SysNameRect.Y + SysNameRect.Height / 2 - Fonts.Pirulen16.LineSpacing / 2));
				ScreenManager.SpriteBatch.DrawString(Fonts.Pirulen16, p.ParentSystem.Name, SysNameCursor, TextColor);
			}
			else
			{
				Vector2 SysNameCursor = new Vector2((float)(SysNameRect.X + SysNameRect.Width / 2) - Fonts.Pirulen12.MeasureString(p.ParentSystem.Name).X / 2f, (float)(SysNameRect.Y + SysNameRect.Height / 2 - Fonts.Pirulen12.LineSpacing / 2));
			...
			Vector2 cursor = new Vector2((float)(PopRect.X + PopRect.Width - 5), (float)(PlanetNameRect.Y + PlanetNameRect.Height / 2 - Fonts.Arial12.LineSpacing / 2));
			...
			cursor = new Vector2((float)(FoodRect.X + FoodRect.Width - 5), (float)(PlanetNameRect.Y + PlanetNameRect.Height / 2 - Fonts.Arial12.LineSpacing / 2));
			if (p.Owner.data.Traits.Cybernetic == 0)
			{
			...
			cursor = new Vector2((float)(ProdRect.X + FoodRect.Width - 5), (float)(PlanetNameRect.Y + PlanetNameRect.Height / 2 - Fonts.Arial12.LineSpacing / 2));
			if (p.Owner.data.Traits.Cybernetic != 0)
			{
			...
			cursor = new Vector2((float)(ResRect.X + FoodRect.Width - 5), (float)(PlanetNameRect.Y + PlanetNameRect.Height / 2 - Fonts.Arial12.LineSpacing / 2));
			...
			cursor = new Vector2((float)(MoneyRect.X + FoodRect.Width - 5), (float)(PlanetNameRect.Y + PlanetNameRect.Height / 2 - Fonts.Arial12.LineSpacing / 2));
			...
			if (Fonts.Pirulen16.MeasureString(p.Name).X + (float)planetIconRect.Width + 10f <= (float)PlanetNameRect.Width)
			{
				Vector2 PlanetNameCursor = new Vector2((float)(planetIconRect.X + planetIconRect.Width + 10), (float)(SysNameRect.Y + SysNameRect.Height / 2 - Fonts.Pirulen16.LineSpacing / 2));
				ScreenManager.SpriteBatch.DrawString(Fonts.Pirulen16, p.Name, PlanetNameCursor, TextColor);
			}
			else if (Fonts.Pirulen12.MeasureString(p.Name).X + (float)planetIconRect.Width + 10f <= (float)PlanetNameRect.Width)
			{
				Vector2 PlanetNameCursor = new Vector2((float)(planetIconRect.X + planetIconRect.Width + 10), (float)(SysNameRect.Y + SysNameRect.Height / 2 - Fonts.Pirulen12.LineSpacing / 2));
				ScreenManager.SpriteBatch.DrawString(Fonts.Pirulen12, p.Name, PlanetNameCursor, TextColor);
			}
			else
			{
				Vector2 PlanetNameCursor = new Vector2((float)(planetIconRect.X + planetIconRect.Width + 10), (float)(SysNameRect.Y + SysNameRect.Height / 2 - Fonts.Arial8Bold.LineSpacing / 2));
			...
			if (p.ConstructionQueue.Count > 0)
			{
				...
				Vector2 bCursor = new Vector2((float)(QueueRect.X + 10), (float)(QueueRect.Y + QueueRect.Height / 2 - 15));
				if (qi.isBuilding)
				{
		...
		{
			string str1;
			ScreenManager.SpriteBatch.Draw(ResourceManager.Texture("NewUI/slider_grd_green"), new Rectangle(ColonySliderFood.sRect.X, ColonySliderFood.sRect.Y, (int)(ColonySliderFood.amount * (float)ColonySliderFood.sRect.Width), 6), new Rectangle?(new Rectangle(ColonySliderFood.sRect.X, ColonySliderFood.sRect.Y, (int)(ColonySliderFood.amount * (float)ColonySliderFood.sRect.Width), 6)), (p.Owner.data.Traits.Cybernetic == 0 ? Color.White : Color.DarkGray));
			...
			for (int i = 0; i < 11; i++)
			{
				tickCursor = new Vector2((float)(ColonySliderFood.sRect.X + ColonySliderFood.sRect.Width / 10 * i), (float)(ColonySliderFood.sRect.Y + ColonySliderFood.sRect.Height + 2));
			...
			Vector2 textPos = new Vector2((float)(SliderRect.X + SliderRect.Width - 5), (float)(ColonySliderFood.sRect.Y + ColonySliderFood.sRect.Height / 2 - Fonts.Arial12Bold.LineSpacing / 2));
		    string food;
            if (p.Owner.data.Traits.Cybernetic == 0)
			{
				float netFoodPerTurn = p.NetFoodPerTurn - p.Consumption;
			...
			for (int i = 0; i < 11; i++)
			{
				tickCursor = new Vector2((float)(ColonySliderFood.sRect.X + ColonySliderProd.sRect.Width / 10 * i), (float)(ColonySliderProd.sRect.Y + ColonySliderProd.sRect.Height + 2));
			...
			textPos = new Vector2((float)(SliderRect.X + SliderRect.Width - 5), (float)(ColonySliderProd.sRect.Y + ColonySliderProd.sRect.Height / 2 - Fonts.Arial12Bold.LineSpacing / 2));
			if (p.Owner.data.Traits.Cybernetic != 0)
			{
				float netProductionPerTurn = p.NetProductionPerTurn - p.Consumption;
			...
			ScreenManager.SpriteBatch.Draw(ResourceManager.Texture("NewUI/slider_grd_blue"), new Rectangle(ColonySliderRes.sRect.X, ColonySliderRes.sRect.Y, (int)(ColonySliderRes.amount * (float)ColonySliderRes.sRect.Width), 6), new Rectangle?(new Rectangle(ColonySliderRes.sRect.X, ColonySliderRes.sRect.Y, (int)(ColonySliderRes.amount * (float)ColonySliderRes.sRect.Width), 6)), Color.White);
			...
			for (int i = 0; i < 11; i++)
			{
				tickCursor = new Vector2((float)(ColonySliderFood.sRect.X + ColonySliderRes.sRect.Width / 10 * i), (float)(ColonySliderRes.sRect.Y + ColonySliderRes.sRect.Height + 2));
			...
			textPos = new Vector2((float)(SliderRect.X + SliderRect.Width - 5), (float)(ColonySliderRes.sRect.Y + ColonySliderRes.sRect.Height / 2 - Fonts.Arial12Bold.LineSpacing / 2));
		...
		public void HandleInput(InputState input, ScreenManager ScreenManager)
		{
			...
			slider1Last = (float)ColonySliderFood.cursor.X;
			slider2Last = (float)ColonySliderProd.cursor.X;
			slider3Last = (float)ColonySliderRes.cursor.X;
			ColonySliderFood.amount = p.FarmerPercentage;
			ColonySliderFood.cursor = new Rectangle(ColonySliderFood.sRect.X + (int)((float)ColonySliderFood.sRect.Width * ColonySliderFood.amount) - ResourceManager.Texture("NewUI/slider_crosshair").Width / 2, ColonySliderFood.sRect.Y + ColonySliderFood.sRect.Height / 2 - ResourceManager.Texture("NewUI/slider_crosshair").Height / 2, ResourceManager.Texture("NewUI/slider_crosshair").Width, ResourceManager.Texture("NewUI/slider_crosshair").Height);
			ColonySliderProd.amount = p.WorkerPercentage;
			ColonySliderProd.cursor = new Rectangle(ColonySliderProd.sRect.X + (int)((float)ColonySliderProd.sRect.Width * ColonySliderProd.amount) - ResourceManager.Texture("NewUI/slider_crosshair").Width / 2, ColonySliderProd.sRect.Y + ColonySliderProd.sRect.Height / 2 - ResourceManager.Texture("NewUI/slider_crosshair").Height / 2, ResourceManager.Texture("NewUI/slider_crosshair").Width, ResourceManager.Texture("NewUI/slider_crosshair").Height);
			ColonySliderRes.amount = p.ResearcherPercentage;
			ColonySliderRes.cursor = new Rectangle(ColonySliderRes.sRect.X + (int)((float)ColonySliderRes.sRect.Width * ColonySliderRes.amount) - ResourceManager.Texture("NewUI/slider_crosshair").Width / 2, ColonySliderRes.sRect.Y + ColonySliderRes.sRect.Height / 2 - ResourceManager.Texture("NewUI/slider_crosshair").Height / 2, ResourceManager.Texture("NewUI/slider_crosshair").Width, ResourceManager.Texture("NewUI/slider_crosshair").Height);
		...
		public void SetNewPos(int x, int y)
		{
			...
			SysNameRect = new Rectangle(x, y, (int)((float)(TotalEntrySize.Width - (SliderWidth + 150)) * 0.17f) - 30, TotalEntrySize.Height);
			PlanetNameRect = new Rectangle(x + SysNameRect.Width, y, (int)((float)(TotalEntrySize.Width - (SliderWidth + 150)) * 0.17f), TotalEntrySize.Height);
