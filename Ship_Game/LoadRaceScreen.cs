...
namespace Ship_Game
{
    public sealed class LoadRaceScreen : GameScreen, IDisposable
    {
        ...
        public LoadRaceScreen(RaceDesignScreen screen)
        {
            this.screen = screen;
            base.IsPopup = true;
        ...
        public override void LoadContent()
        {
            ...
            this.NameSave.AddTab("Load Saved Race");
            ...
            for (int i = 0; i < (int)filesFromDirectory.Length; i++)
            {
                ...
                try
                {
                    ...
                    //data.SetFileInfo(new FileInfo(string.Concat(path, "/StarDrive/Saved Races/", data.SaveName, ".xml.gz")));
