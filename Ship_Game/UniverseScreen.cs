...
namespace Ship_Game
{
    public class UniverseScreen : GameScreen, IDisposable
    {
        ...
        public ManualResetEvent WorkerSemaphore = new ManualResetEvent(true);
        ...
        //private void EmpireThread()       //This is not referenced anywhere. Commenting out so I can code-search without this stuff coming up -Gretman
        //{
        ...
        public void LoadGraphics()
        {
            ...
            if (loadFogPath == null)
            {
                FogMap = ResourceManager.TextureDict["Textures/UniverseFeather"];
            }
            else
            {
            ...
            FTLManager.FTLTexture           = content.Load<Texture2D>("Textures/Ships/FTL");
        ...
        //public void ShipUpdater()     //This is not referenced anywhere. Commenting out so I can code-search without this stuff coming up -Gretman
        //{
        //    while (true)
        //    {
        ...
        //public void SystemUpdater(object data)        //This is not referenced anywhere. Commenting out so I can code-search without this stuff coming up -Gretman
        //{
           ...
           // lock (GlobalStats.DeepSpaceLock)
            {
                foreach (Projectile item_0 in this.DSProjectilesToAdd)
                    DeepSpaceManager.CollidableObjects.Add((GameplayObject)item_0);
            }
            this.DSProjectilesToAdd.Clear();
            DeepSpaceManager.Update(elapsedTime, (SolarSystem)null);
        }
        ...
        public override void ExitScreen()
        {
            ...
            foreach (SolarSystem solarSystem in SolarSystemList)
            {
                ...
                foreach (Asteroid asteroid in (List<Asteroid>)solarSystem.AsteroidsList)
                {
                    if (asteroid.GetSO() != null)
                    {
                        ...
                        ScreenManager.inter.ObjectManager.Remove((ISceneObject)asteroid.GetSO());
                    }
                }
            ...
            {
                spaceJunk.trailEmitter = null;
                spaceJunk.JunkSO.Clear();
                ScreenManager.inter.ObjectManager.Remove((ISceneObject)spaceJunk.JunkSO);
                spaceJunk.JunkSO = null;
            }
            ...
            FTLManager.universeScreen             = null;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (this.Debug)
            {
                ...
                lines.Add("Ship Lag(s): "      + Perfavg2);
                lines.Add("Empire Lag(s): "    + perfavg);
                lines.Add("PreEmpire Lag(s): " + perfavg3);
                lines.Add("Post Empire Lag(s): " + perfavg4);
                lines.Add("");
                lines.Add("Total Lag(s): " + perfavg5);

                Vector2 position = new Vector2(ScreenManager.GraphicsDevice.PresentationParameters.BackBufferWidth - 250f, 44f);
                DrawLines(position, lines);
            }
            if (IsActive)
            ...
            //lock (GlobalStats.BombLock)
            {
                try
                {
                    ...
                    foreach (Bomb item_0 in (List<Bomb>)this.BombList)
                        this.DrawTransparentModel(item_0.Model, item_0.World, this.view, this.projection, item_0.Texture, 0.5f);
                    this.BombList.thisLock.ExitReadLock();
                }
                catch
                {
