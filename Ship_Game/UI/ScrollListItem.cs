...
namespace Ship_Game
{
    public class ScrollListItem<T> : ScrollListItemBase where T : ScrollListItem<T>
    {
        ...
        public void AddPlus(Vector2 relPos, in ToolTipText tooltip, Action onClick = null)  => AddElement(relPos, tooltip, onClick, () => List.GetStyle().BuildAdd);
        public void AddEdit(Vector2 relPos, in ToolTipText tooltip, Action onClick = null)  => AddElement(relPos, tooltip, onClick, () => List.GetStyle().BuildEdit);
        public void AddUp(Vector2 relPos, in ToolTipText tooltip, Action onClick = null)    => AddElement(relPos, tooltip, onClick, () => List.GetStyle().QueueArrowUp);
        public void AddDown(Vector2 relPos, in ToolTipText tooltip, Action onClick = null)  => AddElement(relPos, tooltip, onClick, () => List.GetStyle().QueueArrowDown);
        public void AddApply(Vector2 relPos, in ToolTipText tooltip, Action onClick = null) => AddElement(relPos, tooltip, onClick, () => List.GetStyle().QueueRush);
        public void AddCancel(Vector2 relPos, in ToolTipText tooltip, Action onClick)       => AddElement(relPos, tooltip, onClick, () => List.GetStyle().QueueDelete);
