...
namespace Ship_Game
{
    public class FadeInOutAnim : UIEffect
    {
        ...
        public FadeInOutAnim(UIElementV2 element) : base(element)
        {
        }
        ...
        public FadeInOutAnim Loop(float loopTime = 0f)
        {
        ...
        public FadeInOutAnim Alpha(float min=0f, float max=1f) // [0.0 - 1.0]
        {
            AnimateAlpha = true;
            MinAlpha = min;
            MaxAlpha = max;
        ...
        public FadeInOutAnim Color(Color minColor, Color maxColor)
        {
            AnimateColor = true;
            MinColor = minColor;
            MaxColor = maxColor;
