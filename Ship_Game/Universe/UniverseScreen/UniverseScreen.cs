...
namespace Ship_Game
{
    public sealed partial class UniverseScreen : GameScreen
    {
        ...
        private void DoParticleLoad()
        {
            ...
            explosionParticles       = new ParticleSystem(content, "3DParticles/ExplosionSettings", device, 4);
            photonExplosionParticles = new ParticleSystem(content, "3DParticles/PhotonExplosionSettings", device, 2);
            explosionSmokeParticles  = new ParticleSystem(content, "3DParticles/ExplosionSmokeSettings", device, 4);
            projectileTrailParticles = new ParticleSystem(content, "3DParticles/ProjectileTrailSettings", device, 2f);
            fireTrailParticles       = new ParticleSystem(content, "3DParticles/FireTrailSettings", device,2);
            smokePlumeParticles      = new ParticleSystem(content, "3DParticles/SmokePlumeSettings", device , 2);
            fireParticles            = new ParticleSystem(content, "3DParticles/FireSettings", device, 4);
            ...
            sparks                   = new ParticleSystem(content, "3DParticles/sparks", device, 2);
