...
namespace Ship_Game
{
    public partial class Planet : SolarSystemBody, IDisposable
    {
        ...
        public float TotalBuildingOffense => BuildingList.Sum(b => b.Offense);
        public float TotalSpaceOffense    => TotalBuildingOffense + OrbitalStations.Values.Sum(o => o.BaseStrength);
