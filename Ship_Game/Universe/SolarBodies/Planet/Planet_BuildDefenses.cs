    ...
    public struct WantedOrbitals
    {
        ...
        public WantedOrbitals(int rank)
        {
            switch (rank)
            {
                ...
                case 6: Platforms  = 0; Stations = 1; Shipyards = 1; break;
                ...
                case 10: Platforms = 0; Stations = 3; Shipyards = 2; break;
                case 11: Platforms = 3; Stations = 3; Shipyards = 2; break;
                case 12: Platforms = 0; Stations = 4; Shipyards = 2; break;
                case 13: Platforms = 0; Stations = 4; Shipyards = 2; break;
                case 14: Platforms = 0; Stations = 4; Shipyards = 2; break;
